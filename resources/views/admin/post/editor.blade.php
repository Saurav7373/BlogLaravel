            ...
            <div class="box-body">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group" data-select2-id="13">
                  ...
                  @foreach($tags as $tag)
                    <option value="{{ $tag->id}}"</option>{{ $tag->name }}</option>
                    @endforeach 
                ...
                <div class="form-group" data-select2-id="13">
                  ...
                  <select class="form-control select2 select2-hidden-accessible"  multiple data-placeholder="Select Category" style="width: 100%;" data-select2-id="7" tabindex="-1" aria-hidden="true" name="categories[]">
                  @foreach($categories as $category)
                    <option value="{{ $category->id}}"</option>{{ $category->name }}</option>
                    @endforeach 
